function showTime() { 
	...
	var startDate = new Date(2018, 3, 5,21,52);
	...
	if (seconds < 10) 
	seconds = "0" + seconds; 
	var currentTimeString = "sprite:<br>"
		...
		+	"<c style=\"color: #CCCCCC; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:20px\" >----xusj  2018-05-20</c>"; 
